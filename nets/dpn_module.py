...
def _dpn68(num_classes=1000, pretrained='imagenet'):
    model = DPN(
...
def _dpn68b(num_classes=1000, pretrained='imagenet+5k'):
    model = DPN(
        small=True, num_init_features=10, k_r=128, groups=32,
...
def _dpn92(num_classes=1000, pretrained='imagenet+5k'):
    model = DPN(
...
def _dpn98(num_classes=1000, pretrained='imagenet'):
    model = DPN(
...
def _dpn131(num_classes=1000, pretrained='imagenet'):
    model = DPN(
...
def _dpn107(num_classes=1000, pretrained='imagenet+5k'):
    model = DPN(
...
def _calc_in_chs(small, k_sec, inc_sec):
    bw_factor = 1 if small else 4
