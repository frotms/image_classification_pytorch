...
# https://github.com/Megvii-BaseDetection/YOLOX/blob/main/yolox/utils/dist.py
...
# https://bbs.cvmart.net/articles/3982
# 合并结果的函数
...
########################################################################################################################
# https://github.com/open-mmlab/mmcv/blob/master/mmcv/runner/dist_utils.py#L80
def get_dist_info():
